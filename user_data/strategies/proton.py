...
class Proton(IStrategy):
    ...
    minimal_roi = {"0": 1 + prediction_diff_perc_2 * custom_leverage - 0.0011}
    ...
    plot_config = {
        ...
        "subplots": {
            ...
            "predict": {"do_predict": {"color": "black"}},
    ...
    def bot_start(self, **kwargs) -> None:
        ...
        self.prediction_diff_perc_1 = self.config["proton_parameters"][
            "minimal_price_perc_difference_1"
        ]
        self.prediction_diff_perc_2 = self.config["proton_parameters"][
            "minimal_price_perc_difference_2"
        ]

        self.use_half_label_period_candle = self.config["proton_parameters"][
            "use_half_label_period_candle"
        ]

        self.num_label_2 = self.freqai_info["feature_parameters"][
    ...
    def feature_engineering_expand_basic(
        ...
        # Percentage changes
        dataframe["%-pct-change-1"] = dataframe["close"].pct_change(
            periods=self.num_label_1
        )
        dataframe["%-pct-volume-change-1"] = dataframe["volume"].pct_change(
            periods=self.num_label_1
        )

        if self.use_half_label_period_candle:
            dataframe["%-pct-change-2"] = dataframe["close"].pct_change(
                periods=self.num_label_2
            )
            dataframe["%-pct-volume-change-2"] = dataframe["volume"].pct_change(
                periods=self.num_label_2
            )
        ...
        dataframe["distance-close-sma"] = dataframe["close"] - ta.SMA(
            dataframe, timeperiod=10
        )
        dataframe["%-pct-distance-close-sma"] = dataframe[
            "distance-close-sma"
        ].pct_change(periods=self.num_label_1)
    ...
    def feature_engineering_standard(
        ...
        dataframe.loc[
            (dataframe["ema100"] < dataframe["close"]), "%-ema100-up-down"
        ] = 1
        ...
        dataframe.loc[
            (dataframe["sma100"] < dataframe["close"]), "%-sma100-up-down"
        ] = 1
        ...
        dataframe.loc[
            (dataframe["ema200"] < dataframe["close"]), "%-ema200-up-down"
        ] = 1
        ...
        dataframe.loc[
            (dataframe["sma200"] < dataframe["close"]), "%-sma200-up-down"
        ] = 1
        ...
        dataframe.loc[
            (
                ...
                & (
                    ichimoku["leading_senkou_span_a"]
                    > ichimoku["leading_senkou_span_b"]
                )
            ),
            "%-ichimoku-up-down",
        ] = 1
        ...
        dataframe.loc[
            np.isnan(dataframe["%-ichimoku-up-down"]), "%-ichimoku-up-down"
        ] = 0

        # vwma(20)
        dataframe["vwma20"] = ftt.vwma(dataframe, 20)
        dataframe.loc[
            (dataframe["vwma20"] < dataframe["close"]), "%-vwma20-up-down"
        ] = 1
        ...
        dataframe.loc[
            (
                (stoch["slowk"] < 20)
                & qtpylib.crossed_above(stoch["slowk"], stoch["slowd"])
            ),
            "%-stoch-14-3-3-up-down",
        ] = 1
        dataframe.loc[
            (
                (stoch["slowk"] > 80)
                & qtpylib.crossed_below(stoch["slowk"], stoch["slowd"])
            ),
            "%-stoch-14-3-3-up-down",
        ] = -1
        dataframe.loc[
            np.isnan(dataframe["%-stoch-14-3-3-up-down"]), "%-stoch-14-3-3-up-down"
        ] = 0
        ...
        dataframe.loc[
            (
                (dataframe["cci20"] < -100)
                & (dataframe["cci20"] > dataframe["cci20"].shift(1))
            ),
            "%-cci20-up-down",
        ] = 1
        dataframe.loc[
        ...
        dataframe.loc[
            (dataframe["mom"] > dataframe["mom"].shift(1)), "%-mom10-up-down"
        ] = 1
        dataframe.loc[
            (dataframe["mom"] < dataframe["mom"].shift(1)), "%-mom10-up-down"
        ] = -1
        ...
        dataframe.loc[
            (dataframe["macd"] > dataframe["macdsignal"]), "%-macd-12-26-up-down"
        ] = 1
        dataframe.loc[
            (dataframe["macd"] < dataframe["macdsignal"]), "%-macd-12-26-up-down"
        ] = -1
        dataframe.loc[
            np.isnan(dataframe["%-macd-12-26-up-down"]), "%-macd-12-26-up-down"
        ] = 0
        ...
        dataframe.loc[
            np.isnan(dataframe["%-stochrsi-up-down"]), "%-stochrsi-up-down"
        ] = 0
        ...
        dataframe.loc[
            (-1 <= dataframe["tw-movingaverages-avg"])
            & (dataframe["tw-movingaverages-avg"] < -0.5),
            "%-tw-movingaverages-up-down",
        ] = -2
        dataframe.loc[
            (-0.5 <= dataframe["tw-movingaverages-avg"])
            & (dataframe["tw-movingaverages-avg"] < -0.1),
            "%-tw-movingaverages-up-down",
        ] = -1
        dataframe.loc[
            (-0.1 <= dataframe["tw-movingaverages-avg"])
            & (dataframe["tw-movingaverages-avg"] < 0.1),
            "%-tw-movingaverages-up-down",
        ] = 0
        dataframe.loc[
        ...
        dataframe.loc[
            (0.5 <= dataframe["tw-movingaverages-avg"])
            & (dataframe["tw-movingaverages-avg"] < 1),
            "%-tw-movingaverages-up-down",
        ] = 2
        ...
        dataframe.loc[
            (-1 <= dataframe["tw-oscillators-avg"])
            & (dataframe["tw-oscillators-avg"] < -0.5),
            "%-tw-oscillators-up-down",
        ] = -2
        dataframe.loc[
            (-0.5 <= dataframe["tw-oscillators-avg"])
            & (dataframe["tw-oscillators-avg"] < -0.1),
            "%-tw-oscillators-up-down",
        ] = -1
        dataframe.loc[
            (-0.1 <= dataframe["tw-oscillators-avg"])
            & (dataframe["tw-oscillators-avg"] < 0.1),
            "%-tw-oscillators-up-down",
        ] = 0
        dataframe.loc[
        ...
        dataframe.loc[
            (0.5 <= dataframe["tw-oscillators-avg"])
            & (dataframe["tw-oscillators-avg"] < 1),
            "%-tw-oscillators-up-down",
        ] = 2
        ...
        dataframe.loc[
            (-1 <= dataframe["tradingview-avg"])
            & (dataframe["tradingview-avg"] < -0.5),
            "%-tradingview-up-down",
        ] = -2
        dataframe.loc[
            (-0.5 <= dataframe["tradingview-avg"])
            & (dataframe["tradingview-avg"] < -0.1),
            "%-tradingview-up-down",
        ] = -1
        dataframe.loc[
            (-0.1 <= dataframe["tradingview-avg"])
            & (dataframe["tradingview-avg"] < 0.1),
            "%-tradingview-up-down",
        ] = 0
        dataframe.loc[
        ...
        dataframe.loc[
            (0.5 <= dataframe["tradingview-avg"]) & (dataframe["tradingview-avg"] < 1),
            "%-tradingview-up-down",
        ] = 2
        ...
        *Only functional with FreqAI enabled strategies*
        ...
        if not self.dynamic_target:  # target dinamico disabilitato
            ...
            dataframe["&s-up_or_down"] = np.where(
                (
                    (
                        dataframe["close"].shift(-self.num_label_1)
                        > (dataframe["close"] * (1 + self.prediction_diff_perc_1))
                    )
                    & (
                        dataframe["high"]
                        .shift(-self.num_label_2)
                        .rolling(self.num_label_2)
                        .max()
                        >= (dataframe["close"] * (1 + self.prediction_diff_perc_1))
                    )
                ),
            ...
            dataframe["&s-up_or_down"] = np.where(
                (
                    (
                        dataframe["close"].shift(-self.num_label_1)
                        > (dataframe["close"] * (1 + self.prediction_diff_perc_2))
                    )
                    & (
                        dataframe["high"]
                        .shift(-self.num_label_2)
            ...
            dataframe["target_1"] = ta.SMA(
                abs(dataframe["pct-change"]), self.num_label_1
            )
            # imposto un  minimo
            dataframe.loc[
                dataframe["target_1"] < self.prediction_diff_perc_1, "target_1"
            ] = self.prediction_diff_perc_1
            ...
            dataframe["&s-up_or_down"] = np.where(
                ...
                dataframe["pct-change"].shift(-self.num_label_1)
                > dataframe["target_1"],
                "1",
                "0",
            )
    ...
    def populate_indicators(
        ...
        if self.dp.runmode == RunMode.BACKTEST:
            ...
            dataframe["perc-price-variation"] = (
                dataframe["close"].pct_change(periods=self.num_label_1) * 100
            )

            dataframe["perc-price-variation-abs"] = abs(
                dataframe["perc-price-variation"]
            )
            dataframe["perc-price-variation-soglia-1"] = abs(
                self.prediction_diff_perc_1 * 100
            )
            dataframe["perc-price-variation-soglia-2"] = abs(
                self.prediction_diff_perc_2 * 100
            )
            ...
            dataframe.loc[
                (
                    (
                        (
                            dataframe["perc-price-variation"]
                            >= dataframe["perc-price-variation-soglia-1"]
                        )
            ...
            dataframe.loc[(dataframe["DI_values"] > 0), "prediction_index_calc"] = 1
            dataframe["prediction_index"] = (
                dataframe["prediction_index_calc"].cumsum()
                - dataframe["prediction_index_calc"]
            )
            dataframe["prediction_sum"] = (
                dataframe["prediction"].cumsum() - dataframe["prediction"]
            )
            dataframe["prediction_error"] = (
                dataframe["prediction_index"] - dataframe["prediction_sum"]
            )
            dataframe["prediction_error-pct"] = (
                dataframe["prediction_sum"] / dataframe["prediction_index"]
            ) * 100
            #######################################################
            ...
            dataframe.loc[
                (
                    ...
                    & (
                        abs(dataframe["perc-price-variation"])
                        > abs(dataframe["perc-price-variation-soglia-1"])
                    )
                )
                & dataframe["DI_values"]
                > 0,
                "prediction_mov_index_calc",
            ] = 1
            dataframe.loc[
                np.isnan(dataframe["prediction_mov_index_calc"]),
                "prediction_mov_index_calc",
            ] = 0
            dataframe["prediction_mov_index"] = (
                dataframe["prediction_mov_index_calc"].cumsum()
                - dataframe["prediction_mov_index_calc"]
            )
            ...
            dataframe["prediction_mov_sum"] = (
                dataframe["prediction_mov"].cumsum() - dataframe["prediction_mov"]
            )
            # numero di errori di predizione e/o predizioni mancanti
            dataframe["prediction_mov_error"] = (
                dataframe["prediction_mov_index"] - dataframe["prediction_mov_sum"]
            )
            # percentuale di correttezza di predizioni (quelle mancanti sono conteggiate errate)
            dataframe["prediction_mov_error-pct"] = (
                dataframe["prediction_mov_sum"] / dataframe["prediction_mov_index"]
            ) * 100
            ...
            dataframe.loc[
                np.isnan(dataframe["prediction_mov_correctness_index_calc"]),
                "prediction_mov_correctness_index_calc",
            ] = 0
            dataframe["prediction_mov_correctness_index"] = (
                dataframe["prediction_mov_correctness_index_calc"].cumsum()
                - dataframe["prediction_mov_correctness_index_calc"]
            )

            # se prediction_mov == 1 allora e' corretta la predizione
            dataframe.loc[
                (dataframe["prediction_mov_correctness_index_calc"] == 1)
                & (dataframe["prediction_mov"] == 1),
                "prediction_mov_correctness",
            ] = 1
            dataframe.loc[
                np.isnan(dataframe["prediction_mov_correctness"]),
                "prediction_mov_correctness",
            ] = 0
            dataframe["prediction_mov_correctness_sum"] = (
                dataframe["prediction_mov_correctness"].cumsum()
                - dataframe["prediction_mov_correctness"]
            )
            # numero di errori di predizione e/o predizioni mancanti
            dataframe["prediction_mov_correctness_error"] = (
                dataframe["prediction_mov_correctness_index"]
                - dataframe["prediction_mov_correctness_sum"]
            )
            # percentuale di correttezza di predizioni (quelle mancanti sono conteggiate errate)
            dataframe["prediction_mov_correctness_error-pct"] = (
                dataframe["prediction_mov_correctness_sum"]
                / dataframe["prediction_mov_correctness_index"]
            ) * 100
            # percentuale di predizioni fatte sul numero di predizioni possibili
            dataframe["prediction_mov_done_error-pct"] = (
                dataframe["prediction_mov_correctness_index"]
                / dataframe["prediction_mov_index"]
            ) * 100
            ...
            # logger.info
            print(
                f"--> Numero di candele totali: {dataframe['prediction_index'].iloc[-2]}"
            )
            print(
                f"--> Percentuale di predizioni corrette:                  {dataframe['prediction_error-pct'].iloc[-2]} % -- numero posizioni possibili: {dataframe['prediction_index'].iloc[-2]}  -- numero posizioni corrette: {dataframe['prediction_sum'].iloc[-2]} "
            )
            ...
            print(
                f"--> Percentuale di predizioni fatte (solo movimenti):    {dataframe['prediction_mov_done_error-pct'].iloc[-2]} % -- numero predizioni possibili: {dataframe['prediction_mov_index'].iloc[-2]}  -- numero predizioni fatte: {dataframe['prediction_mov_correctness_index'].iloc[-2]} "
            )

            print(
                f"--> Percentuale di predizioni corrette (solo movimenti): {dataframe['prediction_mov_correctness_error-pct'].iloc[-2]} % -- numero predizioni fatte: {dataframe['prediction_mov_correctness_index'].iloc[-2]}  -- numero posizioni corrette: {dataframe['prediction_mov_correctness_sum'].iloc[-2]} "
            )
            # print(f"NB: predizioni fatte verso quelle corrette")

            print(
                f"**** migliorare la percentuale di predizioni fatte :: {dataframe['prediction_mov_done_error-pct'].iloc[-2]} % -- il numero di predizioni dei movimenti ( {dataframe['prediction_mov_correctness_index'].iloc[-2]} ) verso le possibilità di posizioni ( {dataframe['prediction_mov_index'].iloc[-2]} ) sul totale di {dataframe['prediction_index'].iloc[-2]} candele"
            )
            print(
                f"**** migliorare la percentuale di correttezza delle predizioni dei movimenti :: {dataframe['prediction_mov_correctness_error-pct'].iloc[-2]} %  "
            )
    ...
    def custom_exit(
        ...
        **kwargs,
        ...
        if (
            (trade_duration >= self.max_trade_duration)
            & (self.use_half_label_period_candle)
            & (current_profit > 0)
        ) | (
            (trade_duration >= self.max_trade_duration)
            & (not self.use_half_label_period_candle)
        ):
        ...
        dataframe["custom_exit-pct-change"] = dataframe["close"].pct_change(
            periods=self.num_label_1
        )
        dataframe.loc[
            np.isnan(dataframe["custom_exit-pct-change"]), "custom_exit-pct-change"
        ] = 0

        dataframe["custom_exit-target_1"] = ta.SMA(
            abs(dataframe["custom_exit-pct-change"]), self.num_label_1
        )
        dataframe.loc[
            dataframe["custom_exit-target_1"] < self.prediction_diff_perc_1,
            "custom_exit-target_1",
        ] = self.prediction_diff_perc_1
        current_candle = dataframe.iloc[-1].squeeze()
        if (
            current_profit
            > current_candle["custom_exit-target_1"] * self.custom_leverage
        ):
            return "early_profit"

        if current_profit < -(
            current_candle["custom_exit-target_1"] * self.custom_leverage * 3
        ):
            return "stop_loss"
        ...
        if self.dp.runmode == RunMode.BACKTEST:
            ...
            if (
                trade.calc_profit_ratio(current_candle["high"])
                >= current_candle["custom_exit-target_1"]
            ) | (
                trade.calc_profit_ratio(current_candle["low"])
                >= current_candle["custom_exit-target_1"]
            ):
...
def is_rising(column_dataframe, window=3) -> bool:
    ...
    if (
        column_dataframe
        > column_dataframe.shift(1) & column_dataframe.shift(1)
        > column_dataframe(2)
    ):
